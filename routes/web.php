...
Route::get('/pengembalian', [ViewController::class, 'pengembalian'])->name('pengembalian');
Route::post('/return-car', [ViewController::class, 'returnCar'])->name('return.car');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('booking')->group(function () {
        ...
        Route::get('/list-pengembalian', [ListController::class, 'listPengembalian'])->name('list.pengembalian');
    })->name('booking');
});
...
Route::get('/booking/list-pengembalian', [BookingController::class, 'listPengembalian'])->name('booking.list.pengembalian');


Route::post('/booking/confirm-return/{id}', [ListController::class, 'confirmReturn'])->name('booking.confirmReturn');


Route::post('/admin/confirm-return/{id}', [ListController::class, 'confirmReturn'])->name('booking.confirmReturn');
