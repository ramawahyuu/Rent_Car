...
class BookingController extends Controller
{
    ...
    public function confirmReturn($id)
    {
        ...
        return redirect()->route('admin.listPengembalian')->with('status', 'Booking has been confirmed and marked as completed.');
    }
    ...
    public function listPengembalian()
{
    ...
    return datatables()
        ...
        ->addColumn('bukti_image', function ($booking) {
            return '<img src="' . asset('storage/pembayaran/' . $booking->bukti_image) . '" alt="' . $booking->bukti_image . '" height="50" />';
        })
        ->addColumn('status', function ($booking) {
